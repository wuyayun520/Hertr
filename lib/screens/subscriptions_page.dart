...
class _SubscriptionsPageState extends State<SubscriptionsPage> with TickerProviderStateMixin {
  ...
  Future<void> _handleSuccessfulPurchase(PurchaseDetails purchaseDetails) async {
    ...
    DateTime expiry;
    if (purchaseDetails.productID == 'HertrWeekVIP') {
      expiry = now.add(const Duration(days: 7));
    } else if (purchaseDetails.productID == 'HertrMonthVIP') {
  ...
  Widget build(BuildContext context) {
    ...
    final List<List<_Privilege>> planPrivileges = [
      // Weekly
      [
        _Privilege(icon: Icons.eco, text: 'Unlimited plant care browsing'),
        _Privilege(icon: Icons.block, text: 'Ad-free plant experience'),
        _Privilege(icon: Icons.people, text: 'Unlimited profile customization'),
      ],
      // Monthly
      [
        _Privilege(icon: Icons.eco, text: 'Unlimited plant care browsing'),
        _Privilege(icon: Icons.support_agent, text: 'Unlimited AI plant consultation'),
        _Privilege(icon: Icons.block, text: 'Ad-free plant experience'),
        _Privilege(icon: Icons.people, text: 'Unlimited profile customization'),
      ],
    ];
                    ...
                    background: Container(
                      decoration: const BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            Color(0xFF41B26B), // 深绿色
                            Color(0xFFA8E063), // 亮绿色
                            Color(0xFF56AB2F), // 青绿色
                          ],
                        ),
                      ),
                      child: SafeArea(
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_isVip && _vipExpiry != null) ...[
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: const Color(0xFF41B26B).withValues(alpha: 0.4),
                                      blurRadius: 12,
                            ...
                            // Subtitle
                            Text(
                              'Unlock the ultimate plant care experience',
                              style: TextStyle(
                      ...
                      children: [
                              ...
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(16),
                                    border: Border.all(
                                      color: selected ? const Color(0xFF41B26B) : Colors.grey.withValues(alpha: 0.3),
                                      width: 2,
                                    ),
                                    boxShadow: [
                                      BoxShadow(
                                        color: selected 
                                            ? const Color(0xFF41B26B).withValues(alpha: 0.3)
                                      ...
                                      Column(
                                        children: [
                                          Text(
                                            '\$${plan.title}',
                                            style: TextStyle(
                                              color: selected ? Colors.white : const Color(0xFF41B26B),
                                              fontWeight: FontWeight.bold,
                                              fontSize: 28,
                                            ),
                                          ),
                        ...
                        Container(
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(
                              color: const Color(0xFF41B26B).withValues(alpha: 0.2),
                            ),
                            boxShadow: [
                              BoxShadow(
                        ...
                        Row(
                          ...
                          children: [
                            TextButton(
                              onPressed: () => _launchURL('https://www.privacypolicies.com/live/3d976ce1-ff02-448f-8c78-d0e7c64885ce'),
                              child: Text(
                                'Privacy Policy',
                                style: TextStyle(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                '3. Tap Subscriptions\n'
                                '4. Find Plant Premium in the list\n'
