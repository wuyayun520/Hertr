...
Pod::Spec.new do |s|
  s.name         = "ZenithCrystalFlowSuite"
  s.version      = "1.0.0"
  s.summary      = "A collection of iOS Module."
  s.author       = { "ZenithCrystalFlowSuite" => "ZenithCrystalFlowSuite.me" }
  s.homepage     = "ZenithCrystalFlowSuite.homepage"
  s.source       = { :git => "http://ZenithCrystalFlowSuite.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'ZenithCrystalFlowSuite/Classes/**/*'
  s.resources = "ZenithCrystalFlowSuite/Resources/*.bundle"
  s.vendored_libraries = 'ZenithCrystalFlowSuite/Classes/**/*.a'
  ...
  s.dependency 'LinkedME_LinkPage', '1.5.5.4'
