...
fileprivate let dreamStrainData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_live_toast_bg" :*/
fileprivate let mRangeMsg:String = "btn_lito text custom"
fileprivate let userLeaveStr:String = "true height falsest_bg"

/*: "btn_live_toast_arrow" :*/
fileprivate let m_cellPath:String = "current bottom make heightbtn_l"
fileprivate let showOfStr:String = "text make pushast_ar"
fileprivate let dream_selectedFormat:String = "roerror"
...
var k_nearbyValue = false

//: class TalkingLiveTabToast: UIView {
class WillView: UIView {
    // 气泡间距
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dreamStrainData.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var bubbleImgView: UIImageView = {
        ...
        var img = UIImage.sendCollection(name: (String(mRangeMsg.prefix(6)) + "ve_toa" + String(userLeaveStr.suffix(5)))).resizableImage(withCapInsets: bubbleInsets, resizingMode: .stretch)
        //: imgV.image = img
        imgV.image = img
        //: return imgV
        return imgV
    ...
    private lazy var arrowImgView: UIImageView = {
        ...
        imgV.image = UIImage.sendCollection(name: (String(m_cellPath.suffix(5)) + "ive_to" + String(showOfStr.suffix(6)) + dream_selectedFormat.replacingOccurrences(of: "error", with: "w")))
        //: return imgV
        return imgV
        //: }()
    }()
...
extension WillView {
    ...
    func reStartButton(superView: UIView) {
        //: guard LIVETABTOASTISSHOW == false else { return }
        guard k_nearbyValue == false else { return }
        ...
        //: guard PathAppManager.share.appUserConfigMode.liveTabTips.count > 0 else { return }
        guard PathAppManager.share.appUserConfigMode.liveTabTips.count > 0 else { return }
        //: LIVETABTOASTISSHOW = true
        k_nearbyValue = true

        //: textLab.text = PathAppManager.share.appUserConfigMode.liveTabTips
        textLab.text = PathAppManager.share.appUserConfigMode.liveTabTips
        //: let maxWidth = ScreenWidth - 48
        let maxWidth = app_screenFailMarginFormat - 48
