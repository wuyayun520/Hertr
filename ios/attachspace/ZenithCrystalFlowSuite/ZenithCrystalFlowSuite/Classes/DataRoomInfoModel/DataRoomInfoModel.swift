...
/*: "id" :*/
fileprivate let dream_lastMsg:String = "iview"
...
enum ChatModelTypeMultiplierTarget: Int {
    //: case normal = 1
    case normal = 1 // 普通礼物
    //: case myStery  = 2
    case myStery = 2 // 盲盒礼物
...
struct DiskModelType: HandyJSON {
    //: var gid: String!
    var gid: String! // 礼物Id
    //: var price: Int = 0
...
struct TelecastingMeasurable: HandyJSON {
    //: var num: Int?
    var num: Int? /// 数量
    //: var tag: String?
    var tag: String? /// 说明
...
struct GiftSearchedModel: HandyJSON {
