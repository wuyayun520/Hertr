...
fileprivate let notiResumePath:[UInt8] = [0x9e,0x99,0x9e,0x83,0xdf,0x94,0x98,0x93,0x92,0x85,0xcd,0xde,0xd7,0x9f,0x96,0x84,0xd7,0x99,0x98,0x83,0xd7,0x95,0x92,0x92,0x99,0xd7,0x9e,0x9a,0x87,0x9b,0x92,0x9a,0x92,0x99,0x83,0x92,0x93]

/*: "icon_lounge" :*/
fileprivate let mFreshIdent:[Character] = ["i","c","o","n","_","l","o","u"]
fileprivate let show_topData:[Character] = ["n","g","e"]

/*: "#777777" :*/
fileprivate let m_closePath:String = "#777777"

/*: "UID: :*/
fileprivate let showAspectName:[Character] = ["U","I","D",":"]
...
class VideoViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiResumePath.map{$0^247}, encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.sendCollection(name: (String(mFreshIdent) + String(show_topData)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (m_closePath.capitalized))
        //: return lab
        return lab
        //: }()
    }()
...
extension VideoViewCell {
    ...
    func upModel(model: UserModelType) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.glycerolizeNeed(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.appTitleColor()
        nicknameLab.textColor = model.loungePlus ? .needEnable() : .statusBy()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(showAspectName)) + "\(model.uid)"
