...
/*: "\n" :*/
fileprivate let kLeadingFormat:[Character] = ["\n"]
...
class EqualTextView: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        userAdd(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        userAdd(placeholder: nil, placeholderColor: nil)
    }
}
...
extension EqualTextView {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func userAdd(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(ProduceLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(ProduceLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-ProduceLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: TroughContainerInset().top, left: TroughContainerInset().left, bottom: TroughContainerInset().bottom, right: TroughContainerInset().right)
...
extension EqualTextView: UITextViewDelegate {
