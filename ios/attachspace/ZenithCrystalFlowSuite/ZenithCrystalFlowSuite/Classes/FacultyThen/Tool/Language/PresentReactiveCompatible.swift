...
// __CLOSE_PRINT__
//
//  PresentReactiveCompatible.swift
//  Adjust
//
...
@objcMembers open class PresentReactiveCompatible: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = PresentReactiveCompatible()
    //: private(set) var currLanguage: String = FacultyThen.getSystemLangCode()
    private(set) var currLanguage: String = FacultyThen.underListSend()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func filterLanguage(_ language: String) {
...
public extension NSString {
    ...
    @objc func changeLocalized() -> String {
...
extension String {
    ...
    public func equalArguments(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let language = PresentReactiveCompatible.shared.currLanguage
        //: let languageFolder = SVGAEffectTool.default.languagePath
        let languageFolder = ReverberationInsideHoeHandleReactiveCompatible.default.languagePath
