...
enum FullSchemaConvertible: String {
    //: case AppleLogin
...
enum ManagerColumnConvertible: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
/// 性别
//: enum Gender: String {
enum ConnectionClusterLiteral: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum ConfinementScalarLiteral: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum EffectNameProtocol: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum PublishMultiplierTarget: Int {
    //: case isOnGoing = 0
...
@objc enum AssemblageHashable: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum ExtraRepresentable: Int {
    //: case Unavailable = 0
...
enum HeadCaseIterable: CaseIterable {
