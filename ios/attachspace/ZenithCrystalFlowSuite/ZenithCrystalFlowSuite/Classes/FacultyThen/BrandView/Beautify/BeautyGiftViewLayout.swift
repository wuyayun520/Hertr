...
class BeautyGiftViewLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        layoutContentSize = CGSize(width: Int(app_screenFailMarginFormat) * page, height: 2*GiftItemHeight)
    }
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        let x = page * Int(app_screenFailMarginFormat) + pageCol * (itemWidth )
