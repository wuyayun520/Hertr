...
//: @objcMembers public class PossibilityReactiveCompatible: JSONModel {
@objcMembers public class PossibilityReactiveCompatible: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = BeautyItemVersionValueConvertible.Face
...
//: @objc extension PossibilityReactiveCompatible {
@objc extension PossibilityReactiveCompatible {
    //: func initWith(suiteType: BeautyItemType)-> PossibilityReactiveCompatible {
    func motilityPrice(suiteType: BeautyItemVersionValueConvertible) -> PossibilityReactiveCompatible {
        //: let model = PossibilityReactiveCompatible.init()
        let model = PossibilityReactiveCompatible()
