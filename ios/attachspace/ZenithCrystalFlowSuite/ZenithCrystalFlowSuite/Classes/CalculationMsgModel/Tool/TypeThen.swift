...
/*: "App" :*/
fileprivate let kGiftMsg:[Character] = ["A","p","p"]

/*: "blockList_ :*/
fileprivate let showOpData:String = "self lab top as totalblockL"
...
class TypeThen: NSObject {
    ...
    func nameUp() {
        ...
        let diskPath = getDataStraightAndNarrow()
    ...
    func imageNameLive(userId: String) -> Bool {
    ...
    private func getDataStraightAndNarrow() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(kGiftMsg)))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(showOpData.suffix(6)) + "ist_") + "\(uid)")
        //: return filePath
        return filePath
    }
}
