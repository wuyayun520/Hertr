...
class ViewModelType: HandyJSON {
    //: var roomId = ""                           // trtc房间号
    var roomId = "" // trtc房间号
    //: var streamerInfo = TalkingStreamerInfo()
    var streamerInfo = DataLevelHandyJSON() // 主播信息
    //: var livePlayUrl = ""                      // CDN旁路直播拉流地址
    var livePlayUrl = "" // CDN旁路直播拉流地址
    //: var gameList = [TalkingGameListModel]()
    var gameList = [ColorMeasurable]() // 游戏列表
...
class DataLevelHandyJSON: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var headPic = ""
    var headPic = ""
...
class ColorMeasurable: HandyJSON {
    //: var name = ""
    var name = ""
    //: var icon = ""
    var icon = ""
