...
fileprivate let dream_progressStartKey:[UInt8] = [0x7d,0x7a,0x7d,0x60,0x3c,0x77,0x7b,0x70,0x71,0x66,0x2e,0x3d,0x34,0x7c,0x75,0x67,0x34,0x7a,0x7b,0x60,0x34,0x76,0x71,0x71,0x7a,0x34,0x7d,0x79,0x64,0x78,0x71,0x79,0x71,0x7a,0x60,0x71,0x70]

/*: "#E6BD8B" :*/
fileprivate let dreamWrapUrl:String = "#E6BD8Bproduct icon false special cell"

/*: "+ :*/
fileprivate let kModelId:String = "add"

/*: "get json error" :*/
fileprivate let userMomentStr:String = "greet to effectget js"
fileprivate let dreamRawPath:String = "type print point photo maxon error"
...
class LevelReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dream_progressStartKey.map{$0^20}, encoding: .utf8)!)
    }
    ...
    private lazy var pointLab: UILabel = {
        ...
        lab.font = UIFont.bindFor(type: .Semibold, fontSize: 24)
        //: lab.textColor = UIColor.init(hex: "#E6BD8B")
        lab.textColor = UIColor(hex: (String(dreamWrapUrl.prefix(7))))
...
extension LevelReactiveCompatible {
    ...
    func writeStr(point: String, isminiStr: Bool = false) {
        ...
        let attributes = [.foregroundColor: UIColor(hex: (String(dreamWrapUrl.prefix(7))))!, .font: UIFont.bindFor(type: .Semibold, fontSize: isminiStr ? 15 : 24)] as [NSAttributedString.Key: Any]
        ...
        let attributes2 = [.foregroundColor: UIColor(hex: (String(dreamWrapUrl.prefix(7))))!, .font: UIFont.bindFor(type: .Semibold, fontSize: 14)] as [NSAttributedString.Key: Any]
        ...
        do {
            ...
            var url = ReverberationInsideHoeHandleReactiveCompatible.default.pullInConfirmType(type: .VideoCall_femalePoint)
            ...
            if LiveAddrThen.share.interfaceLang == ViewTermConvertible.ar.rawValue {
                ...
                url = ReverberationInsideHoeHandleReactiveCompatible.default.pullInConfirmType(type: .videoCall_femalePoint_ar)
                ...
                url = ReverberationInsideHoeHandleReactiveCompatible.default.pullInConfirmType(type: .videoCall_femalePoint_es)
                ...
                url = ReverberationInsideHoeHandleReactiveCompatible.default.pullInConfirmType(type: .videoCall_femalePoint_pt)
            }
            ...
            printLog(message: (String(userMomentStr.suffix(6)) + String(dreamRawPath.suffix(8))))
        }
    }
}
