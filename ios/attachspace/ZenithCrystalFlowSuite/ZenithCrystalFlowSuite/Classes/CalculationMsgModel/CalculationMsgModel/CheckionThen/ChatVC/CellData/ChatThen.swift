...
/*: _" :*/
fileprivate let app_modelName:[Character] = ["_"]

/*: ".png" :*/
fileprivate let mSpecModeId:[Character] = [".","p","n","g"]
...
//: @objcMembers public class ChatThen: TalkingChatMsgBaseCellData {
@objcMembers public class ChatThen: DiskTopCellData {
    ...
    override public var msgModel: StageLiveModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.ofConvert(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func noCell(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(m_objectTitle)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + PathAppManager.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + PathAppManager.share.loginUserMode.userID + (String(mSpecModeId))
        ...
        let imageData = UIImage.layer(image, pastIcon: 2 * 1024)
