...
/*!消息体数据*/
//: @class AbTalkingChatMsgInfoModel, AbTalkingChatMsgUserModel, AbTalkingChatMsgToUserModel, AbTalkingChatMsgGiftModel, AbTalkingChatMsgTipsModel, VisualCommunicationReactiveCompatible, AbTalkingChatMsgIntimatePhotoModel, AbTalkingChatMsgVideoModel, AbTalkingChatMsgCustomSendModel, AbTalkingChatMsgQuoteModel, AbTalkingChatMsgQuoteDataModel, WantGiftModel;
@class StatusWithModel, ButtonModel, StartingModel, UserActualModel, NameModel, VisualCommunicationReactiveCompatible, StochasticProcessModel, ActualModel, TextLeadingModel, EnableScreenModel, ProfitModel, MomentUserModel;

//: @interface AbTalkingChatMsgBaseModel : JSONModel
@interface StageLiveModel : JSONModel

//: @property (nonatomic, strong)AbTalkingChatMsgInfoModel *msgInfo;
@property (nonatomic, strong)StatusWithModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)ButtonModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)StartingModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)UserActualModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)NameModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)EnableScreenModel *quoteMsgInfo;

//: @property (nonatomic, strong)VisualCommunicationReactiveCompatible *userInfoModel;
@property (nonatomic, strong)VisualCommunicationReactiveCompatible *userInfoModel;
...
@interface StatusWithModel : JSONModel
...
@property (nonatomic, strong) StochasticProcessModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) ActualModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) TextLeadingModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) MomentUserModel *wantGift; /// 想要礼物
...
@interface StochasticProcessModel : JSONModel
...
@interface ActualModel: JSONModel
...
@interface TextLeadingModel: JSONModel
...
@interface StartingModel : JSONModel
...
@interface UserActualModel : JSONModel
...
@interface MomentUserModel : JSONModel
...
@interface EnableScreenModel : JSONModel
...
@property (nonatomic, strong) ProfitModel *renderData;
