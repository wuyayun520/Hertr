...
@objc public enum RestateLabParHashable: UInt {
...
@objc public enum TopExpressionConvertible: UInt {
 ...
 */
//: @objcMembers public class ButtonDataThen: TCommonCellData {
@objcMembers public class ButtonDataThen: HeadDataReactiveCompatible {
    ...
    public var direction: TopExpressionConvertible = .MsgDirectionIncoming
    ...
    public var translateStatus: RestateLabParHashable = .MsgTranslate_init
    ...
    public var msgModel: StageLiveModel = StageLiveModel()
    ...
    public var cellLayout: CompartmentThen!
    ...
    public init(direction: TopExpressionConvertible) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.system()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = CompartmentThen(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = CompartmentThen(isIncomming: false)
    ...
    public override func systemRowBackground(_ width: CGFloat) -> CGFloat {
