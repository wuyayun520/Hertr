...
/*: "id" :*/
fileprivate let userMicKey:[Character] = ["i","d"]
...
struct ModelMeasurable: HandyJSON {
    ...
    var momentPic: ValueTransformable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [LabGalleryModel]? // 相册
    ...
    var aiExtraInfo = HeadMeasurable() // AI模型
    //: var vipSkinId = 0
...
struct ValueTransformable: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [LiveImageHandyJSON]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct LiveImageHandyJSON: HandyJSON {
...
struct LabGalleryModel: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func afterImage(compareTo: LabGalleryModel) -> Bool {
        //: return
        return
...
struct HeadMeasurable: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
