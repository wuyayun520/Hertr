...
fileprivate let notiStatusLabelUrl:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Add" :*/
fileprivate let notiFromKey:String = "make count make typeAdd"

/*: "btn_me_edit" :*/
fileprivate let noti_norContent:String = "BTN"
fileprivate let show_stretchTargetCornerName:String = "self any view_me_"

/*: "Program" :*/
fileprivate let notiPointContent:String = "self return headProgram"
...
class RenderHeaderCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiStatusLabelUrl.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var tipsLab: UILabel = {
        ...
        lb.text = (String(notiFromKey.suffix(3))).localized
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var editImg: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.sendCollection(name: (noti_norContent.lowercased() + String(show_stretchTargetCornerName.suffix(4)) + "edit")))
        //: imag.isUserInteractionEnabled = false
        imag.isUserInteractionEnabled = false
        //: return imag
        return imag
...
extension RenderHeaderCell {
    //: func setViewData(title: String, icon: String) {
    func labName(title: String, icon: String) {
        //: iconImg.image = UIImage.BundleImageNamed(name: icon)
        iconImg.image = UIImage.sendCollection(name: icon)
        //: titleLab.text = title.localized
        titleLab.text = title.localized
        //: if title == "Program" {
        if title == (String(notiPointContent.suffix(7))) {
    ...
    func set() {
        ...
        backBtn.subEqual(width: app_screenFailMarginFormat - 30, height: 50, corners: [.topLeft, .topRight], cornerRadii: .init(width: 8, height: 8))
    }
}
