...
fileprivate let showCenterTitle:[UInt8] = [0x6e,0x69,0x6e,0x73,0x2f,0x64,0x68,0x63,0x62,0x75,0x3d,0x2e,0x27,0x6f,0x66,0x74,0x27,0x69,0x68,0x73,0x27,0x65,0x62,0x62,0x69,0x27,0x6e,0x6a,0x77,0x6b,0x62,0x6a,0x62,0x69,0x73,0x62,0x63]

private func showText(instance num: UInt8) -> UInt8 {
    return num ^ 7
}

/*: "icon_gift_placeholder" :*/
fileprivate let main_containerFormat:String = "let tableicon_g"
fileprivate let kIconContent:String = "lacelive"
fileprivate let kFrameModelName:[Character] = ["o","l","d","e","r"]

/*: "Gift" :*/
fileprivate let mainIndexKey:[Character] = ["G","i","f","t"]

/*: "x%ld" :*/
fileprivate let notiTitleName:String = "type face self suitex%ld"
...
class DiskView: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showCenterTitle.map{showText(instance: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var giftBgView: UIView = {
        ...
        bgView.backgroundColor = .futurism(245, 245, 245, 1)
    ...
    private lazy var giftImgView: UIImageView = {
        ...
        imgV.image = UIImage.sendCollection(name: (String(main_containerFormat.suffix(6)) + "ift_p" + kIconContent.replacingOccurrences(of: "live", with: "h") + String(kFrameModelName)))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var nameLab: UILabel = {
        ...
        lb.text = (String(mainIndexKey)).localized
...
extension DiskView {
    ...
    func withImage(giftModel: SomeoneTransformable, _ isNewProfile: Bool) {
        //: giftImgView.setUrlImage(urlStr: giftModel.img)
        giftImgView.glycerolizeNeed(urlStr: giftModel.img)
