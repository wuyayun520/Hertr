...
fileprivate let noti_conversationPath:[UInt8] = [0x2f,0x28,0x2f,0x32,0x6e,0x25,0x29,0x22,0x23,0x34,0x7c,0x6f,0x66,0x2e,0x27,0x35,0x66,0x28,0x29,0x32,0x66,0x24,0x23,0x23,0x28,0x66,0x2f,0x2b,0x36,0x2a,0x23,0x2b,0x23,0x28,0x32,0x23,0x22]

private func toAdd(index num: UInt8) -> UInt8 {
    return num ^ 70
}
...
class IndexView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_conversationPath.map{toAdd(index: $0)}, encoding: .utf8)!)
    }
...
extension IndexView {
    ...
    private func subviewsSumeraction() {
